        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
               ...
               <li class="{{ Request::is('home*') ? 'active' : '' }}">
                ...
                @if(Bouncer::can('Create_Facility')) 

                  <li class="{{ Request::is('facilities*') ? 'active' : '' }}">
                    <a href="{{url('facilities')}}"><i class="fa fa-database" style="color:#1AB394"></i> <span class="nav-label">Facility</span></a>
                </li>

                @endif

                 @if(Bouncer::can('Create_Patient')) 

                  <li class="{{ Request::is('patients*') ? 'active' : '' }}">
                    <a href="{{url('patients')}}"><i class="fa fa-bars" style="color:#1AB394"></i> <span class="nav-label">Patients</span></a>
                </li>
                ...
                @if(Bouncer::can('Create_User')) 
                 ...
                 <li class="nav metismenu @if(Request::is('outreferrals')
                             ||Request::is('inreferrals')
                                    ...
                                    <ul class="nav metismenu">
                                        @if(Bouncer::can('Create_Inreferral')) 

                                            <li class="{{ Request::is('inreferrals*') ? 'active' : '' }}">
                                                <a href="{{url('inreferrals')}}"><i class="fa fa-angle-double-right"></i> <span class="nav-label">Referrals In</span></a>
                                            </li>

                                        @endif

                                        @if(Bouncer::can('Create_Outreferral')) 
                                             <li class="{{ Request::is('outreferrals*') ? 'active' : '' }}">
                                                <a href="{{url('outreferrals')}}"><i class="fa fa-angle-double-right"></i> <span class="nav-label"> Referrals Out</span></a>
                                            </li>
                 ...
                 @if(Bouncer::can('Create_Diagnosis')) 

                  <li class="{{ Request::is('diagnoses*') ? 'active' : '' }}">
                    <a href="{{url('diagnoses')}}"><i class="fa fa-pencil-square-o" style="color:#1AB394"></i> <span class="nav-label">Diagnosis</span></a>
                </li>

                @endif
                 @if(Bouncer::can('Create_Practitioner')) 

                  <li class="{{ Request::is('practitioners*') ? 'active' : '' }}">
                    <a href="{{url('practitioners')}}"><i class="fa fa-book" style="color:#1AB394"></i> <span class="nav-label">Practitioners</span></a>
                </li>
                ...
                @if(Bouncer::can('Create_User')) 
                 ...
                 ||Request::is('post-upload-countries*') ||Request::is('patientcategories*')
                 ||Request::is('specializations*')
                        ...
                        <ul class="nav metismenu">
                            ...
                            @endif
                             ...
                             @if(Bouncer::can('Create_Patientcategory')) 
                                <li class="{{ Request::is('patientcategories*') ? 'active' : '' }}">
                                    <a href="{{url('patientcategories')}}"><i class="fa fa-angle-double-right"></i> <span class="nav-label">Patient Category</span></a>
                                </li>

                            @endif

                             @if(Bouncer::can('Create_Specialization')) 
                                <li class="{{ Request::is('specializations*') ? 'active' : '' }}">
                                    <a href="{{url('specializations')}}"><i class="fa fa-angle-double-right"></i> <span class="nav-label">Specialization</span></a>
                                </li>
           ...
           <!--  <div class="pull-right">
            ...
            <div>
             ...
             <div class="page-footer-inner"> {{date('Y',time())}} &copy; &nbsp;{{ config('app.name', 'Laravel') }} &nbsp;|&nbsp;
                    <a href="https://www.techdevsystems.co.ke" target="_blank">Techdev Systems</a>
            </div>
        </div>
